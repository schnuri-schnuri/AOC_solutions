...
for i in range(len(b)):
    for j in range(len(b[i])):
        if b[i][j] == "X":
            if giveValue(b,i+1,j) == "M" and giveValue(b,i+2,j) == "A" and giveValue(b,i+3,j) == "S":
                count +=1
            if giveValue(b,i-1,j) == "M" and giveValue(b,i-2,j) == "A" and giveValue(b,i-3,j) == "S":
                count +=1
            if giveValue(b,i,j+1) == "M" and giveValue(b,i,j+2) == "A" and giveValue(b,i,j+3) == "S":
                count +=1
            if giveValue(b,i,j-1) == "M" and giveValue(b,i,j-2) == "A" and giveValue(b,i,j-3) == "S":
                count +=1
            if giveValue(b,i+1,j+1) == "M" and giveValue(b,i+2,j+2) == "A" and giveValue(b,i+3,j+3) == "S":
                count +=1
            if giveValue(b,i-1,j-1) == "M" and giveValue(b,i-2,j-2) == "A" and giveValue(b,i-3,j-3) == "S":
                count +=1
            if giveValue(b,i+1,j-1) == "M" and giveValue(b,i+2,j-2) == "A" and giveValue(b,i+3,j-3) == "S":
